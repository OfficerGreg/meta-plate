         ...
         <div className="panel">
                        ...
                        <div className="panel-body">
                            ...
                            <div className="chart">
                                ...
                                <svg width="563" height="204" className="data-chart" viewBox="0 0 563 204"
                                     xmlns="https://www.w3.org/2000/svg">
                                    <g fill="none" fill-rule="evenodd">
                                        <path className="dataset-1"
                                        ...
                                        <path className="lines" fill="#FFF" opacity=".2"
